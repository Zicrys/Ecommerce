...
<html>
	...
	<body>
		...
		<p>
		Интернет-магазин существует с 2000-го года и является надежным поставщиком мобильных телефонов в России.
		<br>
		<p class="con">Контактная информация:</p>
		<p>
		<br>e-mail: zicrys@mail.ru
		<br>Телефон: 8-927-119-74-66
		<br>ФИО: Петров А.С.
		<br>Юридический адрес: г.Москва, ул.Пушкина 777\3.
		</p>
		<td>
		</tr>
		</table>
